...
public class UserManagementController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = Assets.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<Assets> getAssetById(@PathVariable("assetId") String assetId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) Assets request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = List.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<List<Assets>> getAssetByUserId(@PathVariable("userId") String userId,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<?> updateAsset(@PathVariable("assetId") String assetId,
			@ApiParam(value = "request", required = true) @RequestBody(required = true) Assets request) {
		...
		if (asset != null) {
			...
			if (success) {
				...
				return new ResponseEntity<String>("Check if parents and childrens exists",
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<?> checkAsset(@PathVariable("assetId") String assetId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) Assets request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<?> assetUser(@PathVariable("assetId") String assetId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) User request) {
	...
	public ResponseEntity<?> postRole(
		...
		if (roleService.getRoleByName(request.getName()) == null) {
			if (roleService.isResourcesOk(request)) {
				...
				return new ResponseEntity<String>("Some of the resources doesnt exist",
						HttpStatus.UNPROCESSABLE_ENTITY);
			}
		} else {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<List<Role>> getRolesUser(@PathVariable("userId") String userId) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = String.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<String> addRolesToUser(@PathVariable("userId") String userId,
			@ApiParam(value = "request", required = true) @RequestBody(required = true) List<Role> request) {
		...
		if (user != null) {
			...
			if (success) {
				...
				return new ResponseEntity<String>("Update Failure. Roles must exist and not be related to User.",
						HttpStatus.UNPROCESSABLE_ENTITY);
			}
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<String> deleteRolesFromUser(@PathVariable("userId") String userId,
			@ApiParam(value = "request", required = false) @RequestBody(required = true) List<Role> request) {
		...
		if (user != null) {
			...
			if (success) {
				...
				return new ResponseEntity<String>("Delete failed. Roles must be related to User.",
						HttpStatus.UNPROCESSABLE_ENTITY);
			}
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<String> checkRoleUser(@PathVariable("userId") String userId,
			@PathVariable("roleId") String roleId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) String request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<Role> deleteRole(@PathVariable("roleId") String roleId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) Role request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<?> getResourcesRoles(@PathVariable("roleId") String roleId,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) DummieRequest request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = String.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<String> postResourcesRoles(@PathVariable("roleId") String roleId,
			@ApiParam(value = "request", required = true) @RequestBody(required = true) List<Resource> request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = String.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<String> removeResourceRole(@PathVariable("roleId") String roleId,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = List.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<List<User>> getUsersRole(@PathVariable("roleId") String roleId) {
	...
	@ApiOperation(value = "getSessions", nickname = "getSessions", response = Sessions.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = String.class),
			@ApiResponse(code = 201, message = "OK"), @ApiResponse(code = 400, message = "Bad Request"),
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public List<Sessions> getSessions(
			@ApiParam(value = "request", required = false) @RequestBody(required = false) Sessions request) {
	...
	// @ApiOperation(value = "login", nickname = "login", response =
	// DummieResponse.class)
	// @ApiResponses(value = { @ApiResponse(code = 200, message = "Success",
	// response = String.class),
	// @ApiResponse(code = 201, message = "OK"), @ApiResponse(code = 400,
	// message = "Bad Request"),
	...
	// @ApiParam(value = "request", required = true) @RequestBody(required =
	// true) DummieRequest request){
	//
	...
	public ResponseEntity<?> getUserMe(HttpServletRequest request) {
		...
		if (user != null) {
			// we have to recover the user this way, 'cause the user from
			// context, has not Assets and brings the entry point down
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = String.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public DummieResponse verifyUser(@PathVariable("token") String token,
			@ApiParam(value = "request", required = false) @RequestBody(required = false) DummieRequest request) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success", response = ResponseEntity.class),
			...
			@ApiResponse(code = 401, message = "Unauthorized"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), @ApiResponse(code = 500, message = "Failure") })
	public ResponseEntity<?> changePassword(@PathVariable("userId") String userId,
			@ApiParam(value = "request", required = true) @RequestBody(required = true) changePasswordRequest request) {
